        ...
        >
            <div className="mx-auto flex w-full items-center justify-center gap-3 px-4 py-3 lg:max-w-4xl">
                {auth.user ? (
                    ...
                    <a
                        href={login().url}
                        className="inline-flex items-center gap-2 rounded-sm border border-transparent px-4 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                    >
